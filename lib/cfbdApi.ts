...
// CBB is served by site.web.api.espn.com's mens-college-basketball scoreboard
// (see lib/espn.ts). CFBD does not have a basketball surface — /basketball/*
// returns 404 across every path we probed on /api/debug-cbb.
